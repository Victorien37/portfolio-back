                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <input type="url" class="form-control" placeholder="https://" pattern="https://.*" name="github" id="github">
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text">
                            ...
                            <input type="url" class="form-control" placeholder="https://" pattern="https://.*" name="gitlab" id="gitlab">
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text">
                            ...
                            <input type="url" class="form-control" placeholder="https://" pattern="https://.*" name="linkedin" id="linkedin">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="messages" rows="4"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <input class="form-control" type="file" name="image" id="image" accept="image/png, image/jpeg, image/jpg">
                        </div>
                    </div>
                </div>
            </div>
